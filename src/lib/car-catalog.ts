...
// All car images are now local in /public/cars/ — no external URLs
...
export const CAR_MODELS: CarModel[] = [
  ...
  // ── MG ──
  {
    ...
    fullName: "MG Hector",
    category: "suv",
    image: "/cars/hector.jpg",
    gallery: ["/cars/hector.jpg"],
    startingPrice: 1399000,
    startingPriceDisplay: "₹13.99 L",
    emiFrom: 19600,
    rating: 4.1,
