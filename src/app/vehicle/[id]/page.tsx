...
/* Stitch: luxury_digital_showroom_(client_view) — #3B82F6, Noto Serif + Noto Sans, #0A1628 */
  ...
  return (
    ...
    >
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#0A1628]/80 backdrop-blur-md border-b border-white/5">
        ...
        {/* Sub Nav Tabs */}
        <div className="flex justify-center border-t border-white/5 bg-[#0A1628]/40">
      ...
      <main className="pt-28 pb-24 min-h-screen flex flex-col">
        ...
        <section className="relative w-full aspect-[4/5] overflow-hidden group">
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-8 text-center">
            ...
            <div className="flex flex-col items-center gap-3">
              <Link
                ...
                className="group/btn flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white hover:text-[#0A1628] transition-all duration-300 px-8 py-4 rounded-full text-white font-bold tracking-wider text-sm"
              >
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20">
            <div className="flex gap-2">
              <span className="w-8 h-0.5 bg-[#3B82F6]" />
        ...
        <section className="px-6 py-10">
          <div className="flex items-end justify-between mb-8">
            <div>
              <span className="text-[#3B82F6] text-xs font-bold tracking-[0.2em] uppercase mb-2 block">
                Available Now
              </span>
              <h2
            ...
            <Link
              href="/used-cars"
              className="text-white/40 text-xs font-bold tracking-widest uppercase hover:text-[#3B82F6] transition-colors pb-1 border-b border-white/10"
            >
              View All
            </Link>
          </div>
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-6 space-y-4">
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="flex-1 bg-white text-[#0A1628] text-xs font-bold py-3 rounded-lg hover:bg-[#3B82F6] hover:text-white transition-colors uppercase tracking-widest text-center"
                      >
                        Inquire
                      </button>
                      <Link
        ...
        <section className="px-6 py-8">
          <span className="text-[#3B82F6] text-xs font-bold tracking-[0.2em] uppercase mb-4 block">
            Intelligence
          </span>
        ...
        <section className="px-6 py-10 bg-white/[0.02] border-y border-white/5">
          <div className="flex flex-col items-center text-center">
            <MaterialIcon
              name="diamond"
              className="text-[#3B82F6] text-4xl mb-4"
            />
            <h3
            ...
            <button
              onClick={() => setInquiryOpen(true)}
              className="border border-white/20 px-10 py-3 rounded-full text-white text-xs font-bold tracking-widest uppercase hover:bg-white hover:text-[#0A1628] transition-all"
            >
              Connect With Us
            </button>
          </div>
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 inset-x-0 z-50 bg-[#0A1628]/95 backdrop-blur-xl border-t border-white/5 pb-8 pt-3 max-w-lg mx-auto md:hidden">
