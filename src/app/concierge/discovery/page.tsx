...
/* Stitch: ai_assistant_discovery_view — #3B82F6, Manrope, #0A1628 */
    ...
    >
      ...
      <section className="relative h-[38%] w-full shrink-0 overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
          <div>
            <span className="inline-block px-2 py-0.5 mb-2 rounded bg-[#3B82F6] text-[10px] font-bold text-white uppercase tracking-wider">
              Available
            </span>
          ...
          <Link
            ...
            className="flex h-12 w-12 items-center justify-center rounded-full bg-[#3B82F6] text-white shadow-lg shadow-[#3B82F6]/30"
          >
      ...
      {/* Main Chat Area */}
      <main className="relative flex-1 flex flex-col overflow-hidden bg-[#0A1628] rounded-t-xl -mt-4 z-10">
        <div className="flex-1 overflow-y-auto px-4 pt-6 pb-24 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          <div className="flex gap-3 mb-6">
            <div className="flex-shrink-0 mt-1">
              <div className="h-8 w-8 rounded-full bg-[#3B82F6] flex items-center justify-center text-white text-[18px]">
                <MaterialIcon name="smart_toy" />
              </div>
            </div>
            <div className="flex flex-col gap-3 max-w-[85%]">
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-[#3B82F6] tracking-wide">
                  EXPERT INSIGHT
                </span>
              ...
              {/* Insight Bubble */}
              <div className="rounded-2xl rounded-tl-none bg-[#3B82F6]/10 border border-[#3B82F6]/20 p-4">
              ...
              <div className="rounded-2xl rounded-tl-none bg-[#3B82F6]/10 border border-[#3B82F6]/20 px-4 py-3">
          ...
          <div className="flex items-center gap-1 ml-11 text-slate-400">
            <div className="flex gap-1">
              <div className="h-1 w-1 rounded-full bg-[#3B82F6]/40 animate-bounce" />
              <div className="h-1 w-1 rounded-full bg-[#3B82F6]/40 animate-bounce [animation-delay:-.3s]" />
              <div className="h-1 w-1 rounded-full bg-[#3B82F6]/40 animate-bounce [animation-delay:-.5s]" />
            </div>
          </div>
        </div>

        {/* Quick Action Bar */}
        <div className="absolute bottom-20 left-0 right-0 z-20 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden whitespace-nowrap px-4 py-2 bg-gradient-to-t from-[#0A1628]/80 to-transparent">
          <div className="flex gap-2">
            <button className="px-5 py-2.5 rounded-full bg-[#3B82F6] text-white text-xs font-bold shadow-lg shadow-[#3B82F6]/20 transition-transform active:scale-95">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-slate-900/90 backdrop-blur-xl border-t border-slate-800 p-4 pb-8 flex items-center gap-3">
          ...
          <div className="relative flex-1">
            <input
              className="w-full h-11 rounded-full border-none bg-slate-800 px-5 text-sm focus:ring-1 focus:ring-[#3B82F6] text-white placeholder:text-slate-500"
              placeholder="Ask your assistant..."
              type="text"
            />
            <button className="absolute right-3 top-1/2 -translate-y-1/2 text-[#3B82F6]">
              <MaterialIcon name="mic" />
            </button>
          </div>
          <button className="flex h-11 w-11 items-center justify-center rounded-full bg-[#3B82F6] text-white shadow-md">
