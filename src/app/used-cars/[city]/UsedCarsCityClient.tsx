...
export default function UsedCarsCityClient({ city }: { city: string }) {
  ...
  const { data, isLoading } = useApi(
    () => fetchVehicles({ status: "AVAILABLE", city, limit: 20 }),
    [city]
  );
          ...
          <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
            ...
            <div className="relative shrink-0">
              <select
                ...
                className="h-8 pl-3 pr-7 rounded-full text-[11px] font-semibold border appearance-none outline-none"
                style={{
                  background: activeBrand ? "rgba(16,185,129,0.2)" : "rgba(255,255,255,0.05)",
            ...
            <div className="relative shrink-0">
              <select
                ...
                className="h-8 pl-3 pr-7 rounded-full text-[11px] font-semibold border appearance-none outline-none"
                style={{
                  background: activeFuel ? "rgba(245,158,11,0.2)" : "rgba(255,255,255,0.05)",
